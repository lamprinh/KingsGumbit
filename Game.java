...
public class Game {
	...
	public static List<String>Menu_cards= new ArrayList<String>();
	...
	public static boolean buy() {
		...
		public static String roll_easy(int i, Player p) {
			if (i=1) {
   ...
   public static String roll_normal(int i,Player p) {
	   if (i=1) {
		   	if (p.getPos()>0 && and p.getPos()<=5) {
   ...
   public static String roll_hard(int i,Player p) {
	   if (i=1) {
		   	if (p.getPos()>0 && and p.getPos()<=5) {
