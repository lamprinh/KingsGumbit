...
public abstract class Bank {
	...
	public abstract void tranfer(int i, Player p, Player p0); 
	
	public abstract void buyProperty(int i, Player p, String kn_cards[]) ;// μέθοδος που θα καλείται για να αγοράσει ένας βασιλιάς μια περιοχή από την τράπεζα
