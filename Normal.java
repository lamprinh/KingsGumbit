...
public class Normal extends Bank {
	public static void normalQ1(int i) { // Kataxorounte oi erotiseis to protou paixti stin lysta
		...
		normal_q1.add("Se poio zoo metamorfothike o Dias gia na apagagei tin Europi;");
	...
	public static void normalQ2(int i) { // Kataxorounte oi erotiseis tou deuterou paixti stin lysta
		...
		normal_q2.add("Pote gennithike o Megas Aleksandros;");
		normal_q2.add("Pote egine i katarreusi ton Mukinaikon anaktorikon kentron;");
		normal_q2.add("Pote egine i naumaxia tis Salaminas;");
	...
	public static void normalQ3(int i) { // Kataxorounte oi erotiseis tou tritou paixti stin lysta
		...
		normal_q3.add("O Athanasios Diakos gennithike to 1788 sti ");
		normal_q3.add("Sti maxi tis Alamanas traumatizetai o ");
		normal_q3.add("Thuma ton emfulion diamaxon upirkse o ");
		normal_q3.add("I istoriki niki tou O.Androutsou sti ... ton epebale stratiotiko arxigo tis roumelis");
		normal_q3.add("O panos Kolokotronis gennithike to tis arxes tou 1800 sti ");
		...
		normal_q3.add("Stis arxes tou 1825 i epanastasi brisketai se megalo kinduno eksaitias tou Impraim alla kai ");
	...
	public static void normalQ4(int i) { // Kataxorounte oi erotiseis tou tetartou paixti stin lysta
		...
		normal_q4.add("Mia apo tis aities tis kritikis epanastasis itan ");
		normal_q4.add("Oi othomanikes dunameis poliorkisan ti stis 8 noembriou 1866");
		normal_q4.add("O moustafa kemal gennithike to 1881 sti");
		normal_q4.add("Stis 10 iouniou 1944 o germanikos stratos purpolise to");
		normal_q4.add("O xitler pethane to mina ");
		normal_q4.add("I 27/1 kathierothike diethnis mera mnimis thumaton tou");
		normal_q4.add("Kuria thumata tou olokautomatos itan ");
		...
		normal_q4.add("O psuxros polemos ksekinise liga xronia meta ti liksi tou");
	...
	public static String normala1(int i) { // Kataxorounte oi pithanes apantiseis tou protou paixti stin lysta
		...
		normal_a1.add("a. Iasona b. Eurustheas g. Iraklis");
		normal_a1.add("a. Nestoras b. Priamos g. Poseidonas");
		normal_a1.add("a. Orfea b. Poluneiki g. Kronos");
		...
		normal_a1.add("a. gorgones b. seirines g. sumpligades");
		normal_a1.add("a. Ikaros b. Kentauros g. Kerberos");
		normal_a1.add("a. talos b. argo g. megara");
		normal_a1.add("a. ena b. tessera g. duo");
		normal_a1.add("a. kuklopas b. talos g. risos");
		normal_a1.add("a. Panas b. Kentauros g. Titanas");
		normal_a1.add("a. ta xrusa mila b. to xrusomallo deras g. ton doureio ippo");
		normal_a1.add("a. to liontari tis Nemeas b. oi stabloi tou Augeia g. o fonos tou kentaurou Nessou");
	...
	public static String normala2(int i) { // Kataxorounte oi pithanes apantiseis tou deuterou paixti stin lysta
		...
		normal_a2.add("a. 500 p.x. b. 160 p.x. g. 356 p.x.");
		normal_a2.add("a. 12o ai. b. 10o ai. g. 7o ai.");
		normal_a2.add("a. 508 p.x. b.480 p.x. g. 420 p.x.");
		normal_a2.add("a.444 p.x. b. 438 p.x. g. 500 p.x.");
		normal_a2.add("a. mathimatiki praksi b. karabia g. to antitimo tis eleutheris eisodou ton politon sto theatro");
		normal_a2.add("a. Ippodamou tou milisiou b. Perikli g. Agamemnona");
		normal_a2.add("a. Oloi oi polites b. mono oi stratiotikoi g. osoi mporousan na agorasoun tin panoplia tous");
		...
		normal_a2.add("a. 479p.x. b. 490p.x. g. 520p.x.");
		normal_a2.add("a. apo arrostia tis epoxis b. autoktonise g. dolofonithike apo toublo sto kefali");
		normal_a2.add("a. klopi tou kratous b. diafthora ton neon kai asebeia pros ta theia g. dolofonia");
		normal_a2.add("a. Armodios kai Aristogeitonas b. Iktinos kai Kallikratis g. Axilleas kai Patroklos");
		normal_a2.add("a. Feidias kai Dimitra b. Iktinos kai Kallikratis g. Daidalos kai Ikaros");
	...
	public static String normala3(int i) { // Kataxorounte oi pithanes apantiseis tou tritou paixti stin lysta
		...
		normal_a3.add("a.26-28 Iouliou 1821 b.26 Iouliou 1821 g.25-16 Iouliou 1821");
		normal_a3.add("a.Kolokotronis b.Petrompeis g.Papaflessas");
		normal_a3.add("a.Athanasiou Diakou b.Odussea Androutsou g.Georgiou Karaiskaki");
		normal_a3.add("a.Fokida b.Kalamata g.Tripoli");
		normal_a3.add("a.Kolokotronis b.Diakos g.Petrompeis ");
		normal_a3.add("a.Androutsos b.Diakos g.Papaflessas");
		normal_a3.add("a.tripolitsa b.peloponniso g.grabia");
		normal_a3.add("a.Zakintho b.Sparti g.Kalamata");
		normal_a3.add("a.o Kolokotronis b.o panos Kolokotronis g.Giannis batikiotis ");
		normal_a3.add("a.o Mauromixalis b. o Kolokotronis g. o Diakos");
		normal_a3.add("a.Naupliou b.Kalamatas g.Spartis");
		normal_a3.add("a.maniates b.mesologgites g.antres tou Papaflessa");
		normal_a3.add("a.Dionusio Solomo b.Athanasio Diako g.Odussea Androutso");
		normal_a3.add("a.Arnaoutoglou b.Impraim g.Dramalis");
		normal_a3.add("a.tou Dramali b.tou emfuliou sparagmou g.ton epanalambanomenon itton ton ellinon");
	...
	public static String normala4(int i) { // Kataxorounte oi pithanes apantiseis tou tetartou paixti stin lysta
		...
		normal_a4.add("a.Aprilio b.Iounio g.Ioulio");
		normal_a4.add("a.olokautomatos sosto b.smurnis g.xiou");
		normal_a4.add("a.Ebraioi b.Xristianoi g.Mousoulmanoi");
		normal_a4.add("a.Megali Bretania b.Germania g.Italia");
		normal_a4.add("a.kritikis politeias b.mono tis Ellados g.mono tis kritikis politeias");
		normal_a4.add("a.tis sugxronis Tourkias b.tis Italias g.tis Gallias");
		...
		normal_a4.add("a.b pagkosmios b.a pagkosmiou polemou g.emfulios polemos");
		normal_a4.add("a.Italous b.Tourkous g.Germanous ");
	...
	public void transferFalse(int i, Player[] arr) { // Meionei to portofoli tou paikti poy paizei kai afxanei ekeinoy
		...
		if (Bank.King_area[arr[i].getPos()] != 9) {
			...
			System.out.println("To portofoli tou " + arr[z].getCharacter() + " afxithike kata " + Bank.getAmount()
	...
	public void buyProperty(int i, Player[] arr) { // Elenxei an o paiktis tha agorasei tin perioxi
		if (Bank.King_area[arr[i].getPos()] == 9) {
			if (Game.buy() == true) {
				...
				System.out.println(
						"I perioxi " + Bank.Prop[arr[i].getPos()] + " anikei pleon ston " + arr[i].getCharacter());
			} else {
				System.out.println("O paixtis " + arr[i].getCharacter() + " apofasise na min agorasei tin perioxi.");
			}
		}
	}
}
